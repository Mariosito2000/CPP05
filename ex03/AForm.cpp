...
AForm	*	AForm::makeShrubberyCreationForm(std::string target)
{
	AForm * Form = new ShrubberyCreationForm(target);
	return (Form);
}

AForm	*	AForm::makeRobotomyRequestForm(std::string target)
{
	AForm * Form = new RobotomyRequestForm(target);
	return (Form);
}

AForm	*	AForm::makePresidentialPardonForm(std::string target)
{
